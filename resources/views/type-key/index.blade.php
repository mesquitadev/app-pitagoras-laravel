...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{route('type-key.index')}}">Setores</a>
                </li>
                <li class="active">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="footable table table-stripped toggle-arrow-tiny" id="table-sector">
                            ...
                            @foreach($types as $t)
                                <tr>
                                    <td class="over">{{$t->id}}</td>
                                    <td class="over">{{$t->name}}</td>
                                    <td class="over">{{\Carbon\Carbon::parse($t->created_at )->format('d/m/Y  H:i:s')
                                    }}</td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <button class="btn-warning btn btn-xs"
                                                    ...
                                                    data-id="{{$t->id}}"
                                            >Editar</button>
                                            <button class="btn btn-danger btn-xs" data-id="{{$t->id}}"
                                                    id="delete-type">Apagar</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('type-key.store')}}" id="addKey" method="POST" class="form-horizontal">
                        @csrf
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Identificação do Tipo</label>
                            <div class="col-sm-10">
    ...
    <!--Modal Editar Setor   -->
    <div class="modal inmodal fade" id="edit-type" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('type-key.update')}}" method="post" class="form-horizontal">
                        @method('PUT')
                        @csrf
